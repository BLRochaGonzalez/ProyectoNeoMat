...
public class UserController {
	...
	private List<SettlementBuilding> createSettlementBuildings(Settlement s) {
		...
		SettlementBuilding sbW = new SettlementBuilding(15.0, 10.0, 25.0,
				10.0, 40.0, 0.0, 5, 10.0);
		sbW.setSettlementId(s);
		sbW.setBuildingIds(this.buildingService.findFirstById(1L));
		sbList.add(sbW);
		
		SettlementBuilding sbG = new SettlementBuilding(15.0, 15.0, 20.0,
				15.0, 35.0, 0.0, 5, 10.0);
		sbG.setSettlementId(s);
		sbG.setBuildingIds(this.buildingService.findFirstById(2L));
		sbList.add(sbG);
		
		SettlementBuilding sbC = new SettlementBuilding(15.0, 10.0, 15.0,
				20.0, 45.0, 0.0, 5, 10.0);
		sbC.setSettlementId(s);
		sbC.setBuildingIds(this.buildingService.findFirstById(3L));
		sbList.add(sbC);
		
		SettlementBuilding sbS = new SettlementBuilding(15.0, 20.0, 10.0,
				15.0, 50.0, 0.0, 5, 10.0);
		sbS.setSettlementId(s);
		sbS.setBuildingIds(this.buildingService.findFirstById(4L));
		sbList.add(sbS);
		
		SettlementBuilding sbR = new SettlementBuilding(15.0, 15.0, 25.0,
				20.0, 40.0, 0.0, 5, 10.0);
		sbR.setSettlementId(s);
		sbR.setBuildingIds(this.buildingService.findFirstById(5L));
		sbList.add(sbR);
		
		SettlementBuilding sbE = new SettlementBuilding(0.0, 10.0, 30.0,
				10.0, 50.0, 0.0, 5, 75.0);
		sbE.setSettlementId(s);
		sbE.setBuildingIds(this.buildingService.findFirstById(6L));
		sbList.add(sbE);
		
		SettlementBuilding sbH = new SettlementBuilding(0.0, 140.0, 170.0,
				120.0, 400.0, 100.0, 20, 0.0);
		sbH.setSettlementId(s);
		sbH.setBuildingIds(this.buildingService.findFirstById(7L));
		sbList.add(sbH);
		
		SettlementBuilding sbL = new SettlementBuilding(0.0, 100.0, 130.0,
				140.0, 320.0, 100.0, 20, 0.0);
